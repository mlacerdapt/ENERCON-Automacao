...
'''schedule.every().monday.at("18:00").do(atualizar_bd_PP)
schedule.every().tuesday.at("18:00").do(atualizar_bd_PP)
schedule.every().wednesday.at("18:00").do(atualizar_bd_PP)
schedule.every().thursday.at("18:00").do(atualizar_bd_PP)
schedule.every().friday.at("18:00").do(atualizar_bd_PP)
schedule.every().saturday.at("18:00").do(atualizar_bd_PP)'''

'''schedule.every().monday.at("20:00").do(atualizar_bd_PP)
schedule.every().tuesday.at("20:00").do(atualizar_bd_PP)
schedule.every().wednesday.at("20:00").do(atualizar_bd_PP)
schedule.every().thursday.at("20:00").do(atualizar_bd_PP)
schedule.every().friday.at("20:00").do(atualizar_bd_PP)
schedule.every().saturday.at("20:00").do(atualizar_bd_PP)'''

'''schedule.every().monday.at("23:00").do(atualizar_bd_PP)
schedule.every().tuesday.at("23:00").do(atualizar_bd_PP)
schedule.every().wednesday.at("23:00").do(atualizar_bd_PP)
schedule.every().thursday.at("23:00").do(atualizar_bd_PP)
schedule.every().friday.at("23:00").do(atualizar_bd_PP)
schedule.every().saturday.at("23:00").do(atualizar_bd_PP)'''

'''schedule.every().monday.at("03:00").do(atualizar_bd_PP)
schedule.every().tuesday.at("03:00").do(atualizar_bd_PP)
schedule.every().wednesday.at("03:00").do(atualizar_bd_PP)
schedule.every().thursday.at("03:00").do(atualizar_bd_PP)
schedule.every().friday.at("03:00").do(atualizar_bd_PP)
schedule.every().saturday.at("03:00").do(atualizar_bd_PP)'''

'''schedule.every().monday.at("06:00").do(atualizar_bd_PP)
schedule.every().tuesday.at("06:00").do(atualizar_bd_PP)
schedule.every().wednesday.at("06:00").do(atualizar_bd_PP)
schedule.every().thursday.at("06:00").do(atualizar_bd_PP)
schedule.every().friday.at("06:00").do(atualizar_bd_PP)
schedule.every().saturday.at("06:00").do(atualizar_bd_PP)'''
