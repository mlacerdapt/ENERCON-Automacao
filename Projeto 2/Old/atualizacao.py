...
def atualizacao():
    ...
    sairtransacao()
    sairtransacao()
    print('Segundo arquivo gerado! Transação: COOIS')

    abririq09()
    exportexceliq09()
    sairtransacao()
    sairtransacao()
    print('Terceiro arquivo gerado! Transação: IQ09')

    trans_blank()
    export_menu()
    export_blank()
    print('Quarto arquivo gerado! Transação: Blank')
...
schedule.every().monday.at("06:45").do(atual_stockalerta)
schedule.every().tuesday.at("06:45").do(atual_stockalerta)
schedule.every().wednesday.at("07:10").do(atual_stockalerta)
schedule.every().thursday.at("06:45").do(atual_stockalerta)
schedule.every().friday.at("06:45").do(atual_stockalerta)

schedule.every().monday.at("07:30").do(atualizacao)
schedule.every().tuesday.at("07:30").do(atualizacao)
schedule.every().wednesday.at("07:30").do(atualizacao)
schedule.every().thursday.at("07:30").do(atualizacao)
schedule.every().friday.at("07:30").do(atualizacao)


schedule.every().monday.at("15:30").do(atualizacao)
schedule.every().tuesday.at("15:30").do(atualizacao)
schedule.every().wednesday.at("15:30").do(atualizacao)
schedule.every().thursday.at("15:30").do(atualizacao)
schedule.every().friday.at("15:30").do(atualizacao)
