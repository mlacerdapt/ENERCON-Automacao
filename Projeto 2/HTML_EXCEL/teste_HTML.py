...
output_html_path2 = r"C:\Users\00082300\Downloads\Projeto 2\Farol_MES\templates\index.html"  # Nome do arquivo HTML de saída
...
tabela_html2 = df2.to_html(index=False, classes="tabela", border=0)

# Criando o HTML com o layout atualizado
html_content = f"""
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
with open(output_html_path, "w", encoding="utf-8") as file:
    ...
    with open(output_html_path2, "w", encoding="utf-8") as file:
        file.write(html_content)
